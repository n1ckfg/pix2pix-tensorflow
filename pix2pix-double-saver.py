...
parser.add_argument("--osc_port", type=int, default=6000)
parser.add_argument("--wait_millis", type=int, default=2000)
parser.add_argument("--file_server_url", type=str, default="http://192.168.0.79:8888/")
...
client = udp_client.UDPClient(a.osc_host, a.osc_port)
 
print("OSC Sender: " +str(a.osc_host)+ ":" + str(a.osc_port))
print("")

def send_osc(addr, *args):
    # if(is_print_log):
    #     print("[OSC Send] ", addr, sec)
